...
Use GitHub's [private vulnerability reporting form](https://github.com/xxvw/ICT_Library_MQ5/security/advisories/new). If private reporting is unavailable, ask the [repository owner](https://github.com/xxvw) for a private reporting channel without posting vulnerability details in a public issue.
...
Ordinary detection errors, build failures, and documentation issues belong in the [issue tracker](https://github.com/xxvw/ICT_Library_MQ5/issues). A trading loss alone is not evidence of a security vulnerability; describe the concrete software behavior and impact.
